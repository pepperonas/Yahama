 ...
 */
public abstract class AudioEntityAdvanced extends AudioEntity {


    private int revTime = 15;
    private int revDly = 25;
    private int revLvl = 25;
    ...
    public int getRevDly() {
        return revDly;
    }


    public void setRevDly(int revDly) {
        this.revDly = revDly;
    }
